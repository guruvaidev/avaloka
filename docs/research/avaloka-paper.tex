...
with multi-step data-agent benchmarks (e.g., DABstep) and safety framing from Agents in the Wild.
\end{abstract}
...
\begin{enumerate}
  ...
  eliminated), aligned with DABstep and Agents in the Wild.
\end{enumerate}
...
and incorporate safety framing from Agents in the Wild \citep{agentswild2025,agentswild_site} to emphasize
...
\newblock \emph{Agents in the Wild: Safety, Security, and Beyond}.
\newblock arXiv:2508.05002, 2025. \url{https://arxiv.org/abs/2508.05002}.

\bibitem[Agents in the Wild(2026)]{agentswild_site}
Agents in the Wild (ICLR 2026 Workshop).
